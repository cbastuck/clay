...
#ifndef NUGGET_MODULE_UI_REGISTRY_H_
#define NUGGET_MODULE_UI_REGISTRY_H_

#include <clay-core/registry/ModuleUIRegistry.h>

NAMESPACE_CLAY_NUGGET_BEGIN

class NuggetModuleUIRegistry : public UI::ModuleUIRegistry
{
public:
  template<class T>
  void init()
...
private:
  ...
  {
  public:
    static void addModule(NuggetModuleUIRegistry* pRegistry)
    {
      ...
      typedef typename tCurrentNuggetItem::tUI                   tModuleUI;

      pRegistry->registerModuleUI<tModule, tModuleUI>();

      typedef boost::mpl::next<typename T::type> tNext;
  ...
  {
  public:
    static void addModule(NuggetModuleUIRegistry*){ /* nothing to do here */ }
  };
